...
<input type="text" name="matriculeVoit" class="form-control"/>
</div>
<div class="form-group">
<label class="control-label">Marque Voiture :</label>
<input type="text" name="marqueVoit" class="form-control"/>
</div>
<div class="form-group">
<label class="control-label">Prix Voiture :</label>
<input type="text" name="prixVoit" class="form-control"/>
</div>
<div class="form-group">
